namespace BlazorApp1.CarModels
{
    public class Ticket
    {
        public string Id { get; set; }  // Unique identifier for the ticket
        public string Title { get; set; }  // The title of the ticket
        public string Description { get; set; }  // Detailed description of the issue
        public string ApplicationUserDetailId { get; set; }  // The ID of the user who created the ticket
        public ApplicationUserDetail ApplicationApplicationUserDetails { get; set; }
