...
*/
            ...
            ///9// Creates a table named "Logs" with two columns: 
            //--------------------------------------------------
            // "LogId" (auto-incrementing primary key of type int),
            // "LogMessage" (of type string, not nullable), 
            // "LogTime" (of type DateTime, nullable).
            ////14// Creates a table named "Sources" with two columns:
            //------------------------------------------------------- 
            // "Id" (auto-incrementing primary key of type int),
            // "Name" (of type string, not nullable).
            //**** Make unique index on id and name
            ////12// Creates a table named "Roles" with four columns: 
            //-------------------------------------------------------
            ...
            ////7// Creates a table named "EventTypes" with two columns:
            //---------------------------------------------------------
            // "Id" (auto-incrementing primary key of type int),
            // "Name" (of type string, not nullable).
            ...
            ////16// Creates a table named "UserClaims" with four columns: 
            //----------------------------------------------------------------------
            // "Id" (auto-incrementing primary key of type int),
            // "UserId" (of type string, nullable), 
            // "ClaimType" (of type string, nullable), and 
            // "ClaimValue" (of type string, nullable).
            ////17// Creates a table named "UserLogins" with four columns: 
            //----------------------------------------------------------------
            // "LoginProvider" (of type string, not nullable),
            // "ProviderKey" (of type string, not nullable), 
            // "ProviderDisplayName" (of type string, nullable),
            // "UserId" (of type string, nullable).
            // *** await role and user seeded
            ////18// Creates a table named "UserRoles" with two columns: 
            //------------------------------------------------
            // "UserId" (of type string, not nullable),
            // "RoleId" (of type string, not nullable).
            // ???
            ////19// Creates a table named "UserTokens" with four columns: 
            //-----------------------------------------------------------
            // "UserId" (of type string, not nullable),
            // "LoginProvider" (of type string, not nullable), 
            // "Name" (of type string, not nullable),
            // "Value" (of type string, nullable).
            //***??? more than 1 column?
            ////20// Creates a table named "AspNetRoles" with a single column 
            //---------------------------------------------------------------
            //"Id" (of type string, not nullable).
            ...
            //-------------------------------------------------
            // "Id" (auto-incrementing primary key of type int),
            // "StartDate" (of type DateTime, not nullable), 
            // "EndDate" (of type DateTime, not nullable),
            // "UserDetailId" (of type int, not nullable).
