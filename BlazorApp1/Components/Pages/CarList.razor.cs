...
namespace BlazorApp1.Components.Pages
{
        ...
        private async Task AssignUser()
        {
            ...
            if (selectedUserString != null && selectedCar != null)
            {
                ...
                if (user != null && user.Email != null)
                {
                    ...
                    selectedCar.User = user;
                    selectedCar.UserId = user.Id;
                    var result = await CarService.AssignUserToCarAsync(selectedCar.CarId, selectedUserString, startDate, endDate);
            ...
            if ( selectedCar != null ) 
            {
                Console.WriteLine("Selectedcar wasnt null");
                if (selectedCar.UserId == null)
                {

                    selectedCar.UserId = "3de00zzz-2828-0000-0000-3de000000000";
                }
            }
            else
            {
                Console.WriteLine("Selectedcar was null, needs redo");
            ...
            isUserModalOpen = false;
            isModalOpen = false;
            Console.WriteLine("before savecar...");
            SaveCar();
            //StateHasChanged();
    ...
    //    {
    //        Console.WriteLine($"Method OnUserSelected called. null user... ");

    //    }
    //    else
    //    {
    //        selectedUserString = selectedUser.Id;
