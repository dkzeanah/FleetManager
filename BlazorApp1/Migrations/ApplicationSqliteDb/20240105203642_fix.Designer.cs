...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BlazorApp1.CarModels.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "3614ce74-74ec-4f60-9dd8-e158e412cdf0",
                            ...
                            SecurityStamp = "4f282892-50ce-4483-b4b8-e5620c0b7290",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "7f6fdb8e-0780-454b-848b-a948129c795c",
                            ...
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "d39d8f7f-95c9-4ec9-af1a-bd10bba24476",
                            TwoFactorEnabled = false,
                            UserCarEventId = 0,
                            UserDetailId = 0,
                            UserEventId = 0,
            ...
            modelBuilder.Entity("BlazorApp1.CarModels.ExcelDataRecord", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Data = "Data1",
                            Hash = "hash1",
                            LastModified = new DateTime(2024, 1, 5, 14, 36, 41, 961, DateTimeKind.Local).AddTicks(7409),
                            UploadDate = new DateTime(2024, 1, 5, 14, 36, 41, 961, DateTimeKind.Local).AddTicks(7336)
                        },
                        new
                        {
                            Id = 2,
                            Data = "Data2",
                            Hash = "hash2",
                            LastModified = new DateTime(2024, 1, 5, 14, 36, 41, 961, DateTimeKind.Local).AddTicks(7414),
                            UploadDate = new DateTime(2024, 1, 5, 14, 36, 41, 961, DateTimeKind.Local).AddTicks(7412)
                        });
                });
            ...
            modelBuilder.Entity("BlazorApp1.CarModels.MasterLog", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1L,
                            Message = "App Birth.",
                            Time = new DateTime(2024, 1, 5, 14, 36, 41, 962, DateTimeKind.Local).AddTicks(3562)
                        },
                        new
                        {
                            Id = 2L,
                            Message = "Hello from The past.",
                            Time = new DateTime(2024, 1, 5, 14, 36, 41, 962, DateTimeKind.Local).AddTicks(3603)
                        });
                });
            ...
            modelBuilder.Entity("BlazorApp1.CarModels.TeamType", b =>
                {
                    b.Property<int>("TeamTypeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("BlazorApp1.CarModels.ApplicationUser", b =>
                {
                    ...
                    b.HasOne("BlazorApp1.CarModels.TeamType", null)
            ...
            modelBuilder.Entity("BlazorApp1.CarModels.TeamTimeline", b =>
                {
                    b.HasOne("BlazorApp1.CarModels.TeamType", "Team")
