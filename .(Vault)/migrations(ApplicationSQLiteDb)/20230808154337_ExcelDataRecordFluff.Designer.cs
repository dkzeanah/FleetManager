...
namespace BlazorApp1.Migrations.ApplicationSQLiteDb
{
    ...
    [Migration("20230808154337_ExcelDataRecordFluff")]
    partial class ExcelDataRecordFluff
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BlazorApp1.CarModels.ExcelDataRecord", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Data = "Data1",
                            DataHash = "hash1",
                            LastModified = new DateTime(2023, 8, 8, 10, 43, 37, 97, DateTimeKind.Local).AddTicks(4919),
                            UploadDate = new DateTime(2023, 8, 8, 10, 43, 37, 97, DateTimeKind.Local).AddTicks(4862)
                        },
                        new
                        {
                            Id = 2,
                            Data = "Data2",
                            DataHash = "hash2",
                            LastModified = new DateTime(2023, 8, 8, 10, 43, 37, 97, DateTimeKind.Local).AddTicks(4923),
                            UploadDate = new DateTime(2023, 8, 8, 10, 43, 37, 97, DateTimeKind.Local).AddTicks(4922)
                        });
                });
            ...
            modelBuilder.Entity("BlazorApp1.CarModels.MasterLog", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Message = "App Birth.",
                            Time = new DateTime(2023, 8, 8, 10, 43, 37, 98, DateTimeKind.Local).AddTicks(6634)
                        },
                        new
                        {
                            Id = 2,
                            Message = "Hello from The past.",
                            Time = new DateTime(2023, 8, 8, 10, 43, 37, 98, DateTimeKind.Local).AddTicks(6696)
                        });
                });
