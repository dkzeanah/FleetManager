...
namespace BlazorApp1.Migrations.ApplicationSQLiteDb
{
    ...
    [Migration("20230804043557_excelentity")]
    partial class excelentity
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BlazorApp1.CarModels.ExcelDataRecord", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DataHash = "DataHash1",
                            JsonData = "JsonData1",
                            LastModified = new DateTime(2023, 8, 3, 23, 35, 56, 29, DateTimeKind.Local).AddTicks(4907),
                            UploadDate = new DateTime(2023, 8, 3, 23, 35, 56, 29, DateTimeKind.Local).AddTicks(4860)
                        },
                        new
                        {
                            Id = 2,
                            ...
                            DataHash = "DataHash2",
                            JsonData = "JsonData2",
                            LastModified = new DateTime(2023, 8, 3, 23, 35, 56, 29, DateTimeKind.Local).AddTicks(4913),
                            UploadDate = new DateTime(2023, 8, 3, 23, 35, 56, 29, DateTimeKind.Local).AddTicks(4911)
                        });
                });
            ...
            modelBuilder.Entity("BlazorApp1.CarModels.MasterLog", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Message = "App Birth.",
                            Time = new DateTime(2023, 8, 3, 23, 35, 56, 30, DateTimeKind.Local).AddTicks(3598)
                        },
                        new
                        {
                            Id = 2,
                            Message = "Hello from The past.",
                            Time = new DateTime(2023, 8, 3, 23, 35, 56, 30, DateTimeKind.Local).AddTicks(3630)
                        });
                });
