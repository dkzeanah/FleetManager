...
namespace BlazorApp1.Migrations.ApplicationSQLiteDb
{
    ...
    [Migration("20230808155951_NullableDataExcelDataRecord")]
    partial class NullableDataExcelDataRecord
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BlazorApp1.CarModels.ExcelDataRecord", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Data = "Data1",
                            DataHash = "hash1",
                            LastModified = new DateTime(2023, 8, 8, 10, 59, 50, 651, DateTimeKind.Local).AddTicks(2819),
                            UploadDate = new DateTime(2023, 8, 8, 10, 59, 50, 651, DateTimeKind.Local).AddTicks(2754)
                        },
                        new
                        {
                            Id = 2,
                            Data = "Data2",
                            DataHash = "hash2",
                            LastModified = new DateTime(2023, 8, 8, 10, 59, 50, 651, DateTimeKind.Local).AddTicks(2823),
                            UploadDate = new DateTime(2023, 8, 8, 10, 59, 50, 651, DateTimeKind.Local).AddTicks(2821)
                        });
                });
            ...
            modelBuilder.Entity("BlazorApp1.CarModels.MasterLog", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Message = "App Birth.",
                            Time = new DateTime(2023, 8, 8, 10, 59, 50, 652, DateTimeKind.Local).AddTicks(126)
                        },
                        new
                        {
                            Id = 2,
                            Message = "Hello from The past.",
                            Time = new DateTime(2023, 8, 8, 10, 59, 50, 652, DateTimeKind.Local).AddTicks(161)
                        });
                });
